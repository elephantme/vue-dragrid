...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dragrid_vue__ = __webpack_require__(5);



new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
  el: '#app',
  render: h => h(__WEBPACK_IMPORTED_MODULE_1__dragrid_vue__["a" /* default */])
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_13_0_4_vue_loader_lib_selector_type_script_index_0_dragrid_vue__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_13_0_4_vue_loader_lib_template_compiler_index_id_data_v_f691c9e0_hasScoped_false_node_modules_13_0_4_vue_loader_lib_selector_type_template_index_0_dragrid_vue__ = __webpack_require__(18);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_13_0_4_vue_loader_lib_selector_type_script_index_0_dragrid_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_13_0_4_vue_loader_lib_template_compiler_index_id_data_v_f691c9e0_hasScoped_false_node_modules_13_0_4_vue_loader_lib_selector_type_template_index_0_dragrid_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "dragrid.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] dragrid.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f691c9e0", Component.options)
  } else {
    hotAPI.reload("data-v-f691c9e0", Component.options)
  }
...
var update = __webpack_require__(9)("0b43c544", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/.0.28.4@css-loader/index.js?sourceMap!../node_modules/.13.0.4@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f691c9e0\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/.13.0.4@vue-loader/lib/selector.js?type=styles&index=0!./dragrid.vue", function() {
     var newContent = require("!!../node_modules/.0.28.4@css-loader/index.js?sourceMap!../node_modules/.13.0.4@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f691c9e0\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/.13.0.4@vue-loader/lib/selector.js?type=styles&index=0!./dragrid.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__event__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cache__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service__ = __webpack_require__(17);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created() {
    __WEBPACK_IMPORTED_MODULE_1__event__["a" /* default */].init(this);
    __WEBPACK_IMPORTED_MODULE_2__cache__["a" /* default */].set(this.name, this);
  },
  ...
  data() {
    return {
      name: 'dragrid',
      containerWidth: 960,
      nodes: __WEBPACK_IMPORTED_MODULE_0__config__["b" /* nodes */],
      current: ""
    };
  },
  ...
  computed: {
    cfg() {
      let cfg = Object.assign({}, __WEBPACK_IMPORTED_MODULE_0__config__["a" /* config */]);
      cfg.cellW = Math.floor(this.containerWidth / cfg.col);
      cfg.cellH = cfg.cellW; // 1:1
      return cfg;
    },
    ...
    area() {
      return __WEBPACK_IMPORTED_MODULE_3__service__["a" /* default */].getArea(this.nodes);
    },
  ...
  methods: {
    ...
    // 检测两个节点是否发生碰撞
    checkHit(node1, node2) {
      if (node1.x < node2.x + node2.w && node2.x < node1.x + node1.w && node1.y < node2.y + node2.h && node2.y < node1.y + node1.h) return true;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = nodes;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dragdrop__ = __webpack_require__(15);
...
const eventHandler = {
  ...
  onMouseMove(event) {
    ...
    if (eh.drag) {
      __WEBPACK_IMPORTED_MODULE_0__dragdrop__["a" /* default */].drag(event);
      return;
    }

    if (eh.isDrag(eh.pageX, eh.pageY, event.pageX, event.pageY)) {
      console.log('isDrag');
      __WEBPACK_IMPORTED_MODULE_0__dragdrop__["a" /* default */].dragStart(eh.el, eh.offsetX, eh.offsetY, eh.isResize);
      eh.drag = true;
    }
  },
  ...
  onMouseUp(event) {
    if (eventHandler.drag) {
      __WEBPACK_IMPORTED_MODULE_0__dragdrop__["a" /* default */].dragEnd();
    }
  ...
  isDrag(pageXFrom, pageYFrom, pageXTo, pageYTo) {
    return Math.abs(pageXFrom - pageXTo) > 5 || Math.abs(pageYFrom - pageYTo) > 5;
  }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cache__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  dragStart(el, offsetX, offsetY, isResize) {
    // 要拖拽的节点
    const dragNode = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].searchUp(el, 'dragrid-item');
    // 容器
    const dragContainer = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].searchUp(el, 'dragrid');
    // 拖拽实例
    const instance = __WEBPACK_IMPORTED_MODULE_1__cache__["a" /* default */].get(dragContainer.getAttribute('name'));
    // 拖拽节点
    ...
    const offset = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].getOffset(el, dragNode, { offsetX, offsetY });
    // 容器偏移
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      staticClass: "dragrid-item dragrid-animate",
      class: {
        'dragrid-placeholder': node.id === _vm.current
      },
      ...
      staticClass: "dragrid-item-content"
    }), _vm._v(" "), _c('div', {
      staticClass: "dragrid-drag-bar"
    }), _vm._v(" "), _c('div', {
      staticClass: "dragrid-resize-bar"
    })])
  }), _vm._v(" "), _c('div', {
    staticClass: "dragrid-dragdrop"
  })], 2)])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-f691c9e0", esExports)
  }
}

/***/ })
/******/ ]);
//# sourceMappingURL=app.8c122252.js.map